...
def main():
    ...
    while True:
        ...
        stock_data = dd.calculate_statistics(stock_data)
        print(stock_data)


        # Отрисовка графика и сохранение БД в csv-файл
        if choice == '1':
            style = input("Введите стиль графика (например, 'ggplot', 'seaborn', 'bmh' и т.д.): ")
            ...
            dplt.export_to_csv(stock_data, f'{ticker}_{start_date}_{end_date}')
